// Bản Cloudflare Workers của auth.js — logic giống hệt bản Node, chỉ đổi import sang db.mjs
// (Hyperdrive) thay vì db.js (pg.Pool). Không có gì trong file này phụ thuộc Node-only API
// ngoài node:crypto (đã xác nhận được hỗ trợ đầy đủ trên Workers qua nodejs_compat).
import crypto from "node:crypto";
import { get, run, uid, hashPassword } from "./db.mjs";
